...
export default function DownloadCharacter() {
    ...
    const { modelNodes, scene, templateInfo, model, downloadPopup, setDownloadPopup } = useGlobalState();
